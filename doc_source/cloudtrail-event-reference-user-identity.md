...
+ `Role` – The request was made with a persistent IAM identity that has specific permissions\. The issuer of role sessions is always the role\. For more information about roles, see [Roles terms and concepts](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_terms-and-concepts.html) in the *IAM User Guide*\.
