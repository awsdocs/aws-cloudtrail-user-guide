...
+ [Grant permissions to use the CloudTrail console](#tutorial-grant-permissions)
...
### Grant permissions to use the CloudTrail console<a name="tutorial-grant-permissions"></a>
