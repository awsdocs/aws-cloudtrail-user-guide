...
+ [Amazon S3 Inventory](https://docs.aws.amazon.com/AmazonS3/latest/dev/storage-inventory.html) can help you audit and report on the replication and encryption status of the Amazon S3 buckets you use for storing log files and its objects for business, compliance, and regulatory needs\.